try {
jQuery(function(A){AJS.pagetree={MAX_DEPTH:999,MODE_EXPAND:true,MODE_COLLAPSE:false,treeRequests:{},targetPages:{},isPdlEnabled:function(){return AJS.Meta.getNumber("build-number")>=4000
...
if(F==this.MODE_EXPAND){if(this.isPdlEnabled()){C.removeClass("icon-section-closed").addClass("icon-section-opened")
}else{C.removeClass("icon-plus").addClass("icon-minus")
}}else{if(this.isPdlEnabled()){C.removeClass("icon-section-opened").addClass("icon-section-closed")
}else{C.removeClass("icon-minus").addClass("icon-plus")
...
if(AJS.pagetree.isPdlEnabled()){A("#plusminus"+M).addClass("icon-section-opened").removeClass("icon-section-closed")
}else{A("#plusminus"+M).addClass("icon-minus").removeClass("icon-plus")
