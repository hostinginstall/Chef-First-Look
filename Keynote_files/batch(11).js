...
Confluence.Templates.User.logo = function(opt_data, opt_sb) {
  ...
  if (opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) {
    output.append('<a ', (opt_data.canView) ? ' class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '', ' href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Add a picture of yourself"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.27/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Add a picture of yourself"), '"></a>');
  } else {
    if (opt_data.profilePictureInfo.anonymous) {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.27/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Anonymous"), '" title="', soy.$$escapeHtml("Anonymous"), '">');
      ...
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.27/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '">');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
try {
AJS.toInit(function(){AJS.$("table.attachments tr").each(function(a,b){AJS.$(b).find("td.attachment-actions a").each(function(c,d){if(AJS.$(d).attr("href").indexOf("/plugins/gliffy/view")!=-1){AJS.$(b).find("td.filename-column span").removeClass("icon-file-xml icon-file-unknown").addClass("gliffy-document-icon").attr("title","Gliffy File").text("Gliffy File")}})});if(Confluence&&Confluence.Blueprint&&Confluence.Blueprint.register){Confluence.Blueprint.register("com.gliffy.integration.confluence:gliffy-blueprint-item",function(b,c,a){window.location=Confluence.getContextPath()+"/pages/createpage.action?showGliffyMacro=true&spaceKey="+encodeURIComponent(c)+"&newSpaceKey="+encodeURIComponent(c)})}});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
AJS.toInit(function(){if(AJS.version>="3.0"){var a=AJS.$("#poweredby:visible");if(a.length>0){a.before(AJS.template.load("gliffy-footer-webpanel"))}}});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  ...
  if (opt_data.userInfo.userName == null) {
    ...
    output.append('<a class="userLogoLink" data-username="', soy.$$escapeHtml(opt_data.userInfo.userName), '" href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Add a picture of yourself"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/en_GB-1988229788/4226/d7686547091e645d7b0285207c0b86be721c74eb.27/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("User icon"), ': ', soy.$$escapeHtml("Add a picture of yourself"), '"></a>');
  } else {
...
try {
(function(G){try{if(window.AJS&&AJS.DarkFeatures.isEnabled("heatmapper.disabled")){return 
...
try {
AJS.toInit(function(C){try{if(AJS.DarkFeatures.isEnabled("heatmapper.disabled")){return 
}window.HeatMapper=window.HeatMapper||{};
if(!AJS.Events&&!HeatMapper.Events){AJS.log("Analytics support not installed. Not tracking click events.");
return 
...
}function G(H){if(AJS.Events){AJS.trigger("analyticsEvent",{name:"heatmapper-click",data:H})
...
Confluence.Templates.FileList.dialogForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="#" method="post" id="file-list-form" class="aui"><fieldset><div class="field-group"><label for="file-list-page-title">', soy.$$escapeHtml("Name"), '<span class="aui-icon icon-required"> required</span></label><input id="file-list-page-title" class="text long-field" type="text" name="title" title="title" placeholder="', soy.$$escapeHtml("Title of your file list"), '" maxlength="255"><div class="error"></div></div><div class="field-group"><label for="file-list-page-description">', soy.$$escapeHtml("Description"), '</label><textarea id="file-list-page-description" class="textarea long-field" name="description" rows="6" placeholder="', soy.$$escapeHtml("Description which will appear at the top of file list"), '"></textarea></div><div class="field-group"><label for="file-list-restrictions">', soy.$$escapeHtml("Restrictions"), '</label><input id="file-list-restrictions" class="text long-field autocomplete-multiuser" type="text" name="viewPermissionsUsers" placeholder="', soy.$$escapeHtml("Restrict to users"), '"></div></fieldset></form>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Blueprints.Decisions.dialogForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="#" method="post" id="decisions-form" class="aui"><fieldset><div class="field-group"><label for="decisions-page-title">', soy.$$escapeHtml("Title"), '<span class="aui-icon icon-required"> required</span></label><input id="decisions-page-title" class="text long-field" type="text" name="title" title="title" placeholder="', soy.$$escapeHtml("What are you deciding?"), '" maxlength="255"><div class="error"></div></div><div class="field-group"><label for="decisions-stakeholders">', soy.$$escapeHtml("Stakeholders"), '</label><input id="decisions-stakeholders" class="text long-field autocomplete-multiuser" type="text" name="stakeholders" placeholder="', soy.$$escapeHtml("People who need to make this decision."), '"></div><div class="field-group"><label for="decisions-status">', soy.$$escapeHtml("Status"), '</label><select class="select long-field" id="decisions-status" name="status" title="status"><option>', soy.$$escapeHtml("In Progress"), '</option><option>', soy.$$escapeHtml("Decided"), '</option></select></div><div class="field-group"><label for="decisions-background">', soy.$$escapeHtml("Background"), '</label><textarea id="decisions-background" class="textarea long-field" rows="4" type="text" name="background" title="background" placeholder="', soy.$$escapeHtml("Provide some details about this decision."), '"></textarea></div><div class="field-group"><label for="decisions-final-decision">', soy.$$escapeHtml("Final decision"), '</label><input id="decisions-final-decision" class="text long-field" type="text" name="final-decision" title="final-decision" placeholder="', soy.$$escapeHtml("What did you decide?"), '" maxlength="255"></div></fieldset></form>');
  return opt_sb ? '' : output.toString();
};
...
try {
(function(c){function d(i,h){var e=i.find("#decisions-page-title"),g=c.trim(e.val()),f;if(!g){f="Name is required."}else{if(!Confluence.Blueprint.canCreatePage(h,g)){f="A page with this name already exists."}}if(f){e.focus().siblings(".error").html(f);return false}return true}function a(e,f){f.wizardData.goToIndexPage="true";return d(f.$container,f.wizardData.spaceKey)}function b(e,f){c("#decisions-status").on("change",function(){var h=c("#decisions-final-decision");var g=c("label[for=decisions-final-decision]");if(c(this).find(":selected").val()=="Decided"){h.css({visibility:"visible"});g.css({visibility:"visible"})}else{h.css({visibility:"hidden"});g.css({visibility:"hidden"})}})}Confluence.Blueprint.setWizard("com.atlassian.confluence.plugins.confluence-business-blueprints:decisions-blueprint-item",function(e){e.on("post-render.decisions-page1",b);e.on("submit.decisions-page1",a)})})(AJS.$);
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
try {
(function(){var K={},G=window,J=G.document,C="localStorage",M="globalStorage",D="__storejs__",F;
K.disabled=false;
K.set=function(N,O){};
K.get=function(N){};
K.remove=function(N){};
K.clear=function(){};
K.transact=function(N,O){var P=K.get(N);
if(typeof P=="undefined"){P={}
}O(P);
K.set(N,P)
};
K.serialize=function(N){return JSON.stringify(N)
};
K.deserialize=function(N){if(typeof N!="string"){return undefined
}return JSON.parse(N)
};
function B(){try{return(C in G&&G[C])
}catch(N){return false
}}function L(){try{return(M in G&&G[M]&&G[M][G.location.hostname])
}catch(N){return false
}}if(B()){F=G[C];
K.set=function(N,O){if(O===undefined){return K.remove(N)
}F.setItem(N,K.serialize(O))
};
K.get=function(N){return K.deserialize(F.getItem(N))
};
K.remove=function(N){F.removeItem(N)
};
K.clear=function(){F.clear()
}
}else{if(L()){F=G[M][G.location.hostname];
K.set=function(N,O){if(O===undefined){return K.remove(N)
}F[N]=K.serialize(O)
};
K.get=function(N){return K.deserialize(F[N]&&F[N].value)
};
K.remove=function(N){delete F[N]
};
K.clear=function(){for(var N in F){delete F[N]
}}
}else{if(J.documentElement.addBehavior){var I,E;
try{E=new ActiveXObject("htmlfile");
E.open();
E.write('<script>document.w=window<\/script><iframe src="/favicon.ico"></frame>');
E.close();
I=E.w.frames[0].document;
F=I.createElement("div")
}catch(H){F=J.createElement("div");
I=J.body
}function A(N){return function(){var P=Array.prototype.slice.call(arguments,0);
P.unshift(F);
I.appendChild(F);
...
}K.set=A(function(P,N,O){if(O===undefined){return K.remove(N)
}P.setAttribute(N,K.serialize(O));
P.save(C)
});
K.get=A(function(O,N){return K.deserialize(O.getAttribute(N))
});
K.remove=A(function(O,N){O.removeAttribute(N);
O.save(C)
});
K.clear=A(function(Q){var O=Q.XMLDocument.documentElement.attributes;
Q.load(C);
for(var P=0,N;
N=O[P];
P++){Q.removeAttribute(N.name)
}Q.save(C)
})
}}}try{K.set(D,D);
if(K.get(D)!=D){K.disabled=true
}K.remove(D)
}catch(H){K.disabled=true
}if(typeof module!="undefined"){module.exports=K
}else{if(typeof define==="function"&&define.amd){define(K)
}else{this.store=K
}}})();
} catch (err) {
    if (console && console.log && console.error) {
...
try {
(function(E){var G="atlassian-analytics";
var B=typeof AJS.contextPath=="function"?AJS.contextPath():typeof AJS.Confluence!="undefined"?AJS.Confluence.getContextPath():window.contextPath!=null?window.contextPath:"";
var C=null;
var D=function(){var I=[],K,L,H,J;
if(AJS.EventQueue.length==0){return 
}I=store.get(G)||I;
for(H=0,J=AJS.EventQueue.length;
H<J;
++H){L=AJS.EventQueue[H];
if(L.name){K={name:L.name,properties:L.properties};
I.push(K)
...
D();
H=store.get(G);
if(H&&H.length){store.remove(G);
C=E.ajax({type:"POST",url:B+"/rest/analytics/1.0/publish/bulk",data:E.toJSON(H),contentType:"application/json",dataType:"json"});
C.fail(function(){AJS.EventQueue.concat(H);
D()
})
}};
var F=function(){if(C&&!(C.isResolved()||C.isRejected())){C.abort()
}};
AJS.Events={publish:function(H,I){AJS.EventQueue.push({name:H,properties:I})
}};
AJS.EventQueue=AJS.EventQueue||[];
AJS.toInit(function(){A();
setInterval(A,5000)
});
E(window).unload(function(){F();
D()
});
AJS.bind("analyticsEvent",function(H,I){AJS.Events.publish(I.name,I.data)
})
}(AJS.$));
} catch (err) {
    if (console && console.log && console.error) {
