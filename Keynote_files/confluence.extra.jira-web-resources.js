...
var E=M.exec(I);
if(E){O.empty();
A.bigMessageFunction(C,'<a class="oauth-init" href="'+E[1]+'">'+"Authenticate"+"</a> "+"to retrieve your issues"+"</span>");
...
if(I){F.empty().append($("<a/>",{href:I[1],"class":"oauth-init"}).text("Authenticate").click(function(){AppLinks.authenticateRemoteCredentials(I[1],function(){window.location.reload()
},function(){});
return false
